...
func (s *KeeperTestSuite) TestMsgCreate() {
	...
	extendedVaultPairID1 := s.CreateNewExtendedVaultPair("PETRI-C", appID1, pairID, false, true)
	extendedVaultPairID2 := s.CreateNewExtendedVaultPair("PETRI-C", appID2, pairID, false, true)
	extendedVaultPairID3 := s.CreateNewExtendedVaultPair("PETRI-D", appID1, pairID2, false, false)
	extendedVaultPairID4 := s.CreateNewExtendedVaultPair("PETRI-E", appID1, pairID3, true, false)
...
func (s *KeeperTestSuite) TestMsgCreateStableMint() {
	...
	asseTwoID := s.CreateNewAsset("ASSETTWO", "uasset2", 2000000)
	pairID := s.CreateNewPair(addr1, asseOneID, asseTwoID)
	extendedVaultPairID1 := s.CreateNewExtendedVaultPair("PETRI-C", appID1, pairID, false, false)
	extendedVaultPairID2 := s.CreateNewExtendedVaultPair("PETRI-C", appID2, pairID, true, false)
	extendedVaultPairID3 := s.CreateNewExtendedVaultPair("PETRI-C", appID3, pairID, true, true)
	// extendedVaultPairID4 := s.CreateNewExtendedVaultPair("PETRI-C", appID4, pairID, true, true)
...
func (s *KeeperTestSuite) TestMsgDepositStableMint() {
	...
	pairID := s.CreateNewPair(addr1, asseOneID, asseTwoID)
	extendedVaultPairID1 := s.CreateNewExtendedVaultPair("PETRI-C", appID1, pairID, false, false)
	extendedVaultPairID2 := s.CreateNewExtendedVaultPair("PETRI-A", appID1, pairID, false, true)
	extendedVaultPairID3 := s.CreateNewExtendedVaultPair("PETRI-B", appID1, pairID, true, true)
	extendedVaultPairID4 := s.CreateNewExtendedVaultPair("PETRI-D", appID2, pairID, true, true)
